<div class="cards-list">
     <section>
          <div class="titolo"><h2>Le lunghe</h2></div>
          <div class="cards">
               @foreach ($lunghe as $key => $prodotto)
                    <div class="card">
                         <img src="{{$prodotto['src']}}" alt="{{$prodotto['titolo']}}">
                         <div class="hover">
                              <h3><a href="{{route('prodotti.show',$key)}}">{{$prodotto['titolo']}}</a></h3>
     ...
     <section>
          <div class="titolo"><h2>Le corte</h2></div>
          <div class="cards">
     ...
     <section>
          <div class="titolo"><h2>Le cortissime</h2></div>
          <div class="cards">
